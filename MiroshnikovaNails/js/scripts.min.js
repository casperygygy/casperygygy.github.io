...
$(function() {
	...
	$('#my-menu').mmenu({
		extensions: [ 'theme-black', 'effect-menu-slide', 'pagedim-black', 'border-none', 'fx-listitems-slide', 'listview-huge'],
		navbar: {
			add: true,
			title: "Меню"
		},
  ...
  $('.carousel-services').owlCarousel({
		...
		touchDrag: true,
		nav: false,
		navText: ['<i class="fa fa-arrow-left fa-4x">', '<i class="fa fa-arrow-right fa-4x">'],
		smartSpeed: 500,
	...
	function carouselServices() {
		$('.carousel-services--block').each(function() {
			var eto = $(this),
					etoheight = eto.find('.carousel-services--content').outerHeight();
					eto.find('.carousel-services--img, .carousel-services--img2, .carousel-services--img3').css('min-height', etoheight);
					// eto.find('.carousel-services--img2').css('min-height', etoheight);
					// eto.find('.carousel-services--img3').css('min-height', etoheight);
		});
	}carouselServices();
//Resize Windiow
	function onResize() {
